...
const STATUS_STYLE: Record<string, string> = {
  ...
  MISSING: 'bg-muted text-stone-700',
...
export default function ContractReportDetailPage() {
  ...
  if (!report) {
    return <main className="min-h-screen bg-muted p-10"><div className="mx-auto max-w-4xl rounded-2xl bg-white p-8">{error || '리포트를 불러오는 중...'}</div></main>
  }
