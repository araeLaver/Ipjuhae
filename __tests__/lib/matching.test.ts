...
describe('matchScore', () => {
  ...
  it('8. available_from null → moveIn 30pts (즉시 입주 가능)', () => {
    const profile = makeProfile({ move_in_date: '2026-04-01' })
