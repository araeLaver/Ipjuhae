...
const DEUNGI = [
  {
    num: '01', title: '등기부에서 볼 세 줄', next: '계약 상대가 진짜 주인인가',
    slides: [
      { kind: 'cover', title: '이 집, 계약해도 되는지\n3분이면 압니다', sub: '등기부등본 읽는 법' },
      { kind: 'plain', title: '준비물', desc: '등기부등본 1통.\n인터넷등기소에서 뗄 수 있습니다.' },
      { kind: 'point', label: '하나', title: '갑구에 적힌 소유자', desc: '계약하려는 사람과 이름이 같은지 봅니다.\n대리인이 나왔다면 위임장을 확인하세요.' },
      { kind: 'point', label: '둘', title: '을구에 적힌 근저당', desc: '채권최고액이 시세에 비해 얼마인지 봅니다.\n경매로 넘어가면 은행이 먼저 가져갑니다.' },
      ...
      { kind: 'end', title: '다음 화', desc: '계약 상대가 진짜 주인인가' },
    ],
  },
  {
    num: '02', title: '계약 상대가 진짜 주인인가', next: '근저당과 순위',
    slides: [
      { kind: 'cover', title: '계약 상대가\n진짜 주인인가', sub: '이 집이 누구 것인지 적힌 칸' },
      ...
      { kind: 'end', title: '다음 화', desc: '근저당과 순위' },
    ],
  },
  {
    num: '03', title: '근저당과 순위', next: '신탁 표시가 있으면 멈춘다',
    slides: [
      { kind: 'cover', title: '확정일자보다\n순위가 먼저입니다', sub: '을구에 적힌 근저당' },
...
const LANDLORD = [
  ...
  },
  {
    ...
    slides: [
      ...
      { kind: 'end', title: '연재 끝', desc: '프로필 링크에 커뮤니티가 있습니다. 가입 없이 물어보세요' },
    ],
  },
]
